This code has been tested using Python 2.7.9. Apart from the standard Python libraries it also depends on the SciPy libraries. For those installing Python for the first time I would recommend the Anaconda Python distribution.
