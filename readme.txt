This code has been tested using \*Python 2.7.9\*. Apart from the standard Python libraries it also depends on the [SciPy](http://www.scipy.org/) libraries. For those installing Python for the first time I would recommend the Anaconda Python distribution.

A template running script can be found in runScript.py
