...
class minimize(fitAlg):
    ...
    """The class for simMethods data using scipy.optimise.minimize
    ...
    scipy.optimise.minimize : The simMethods class this wraps around
...
#        """
#        Used for printing state after each stage of simMethods
#        """
#
